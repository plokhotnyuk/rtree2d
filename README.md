...
[![Maven Central](https://img.shields.io/badge/maven--central-0.11.7-blue.svg)](https://search.maven.org/search?q=com.github.plokhotnyuk.rtree2d)
...
```sbt
libraryDependencies += "com.github.plokhotnyuk.rtree2d" %% "rtree2d-core" % "0.11.7"
 ```
